...
- **Task Queue**: Celery + Celery Beat (self-hosted) / Cloud Tasks + Cloud Scheduler (GCP)
...
3. **validibot-pro** - Pro tier features (billing, team management)
   - Located at `../validibot-pro`
   - Contains code that should NOT be in the open-source release
   - See "Open-Core Architecture" section below
4. **validibot-enterprise** - Enterprise tier features (multi-org, SSO)
   - Located at `../validibot-enterprise`
   - Contains code that should NOT be in the open-source release
5. **validibot-marketing** - Marketing website (validibot.com)
...
6. **validibot-project** - Project documentation and ADRs
...
| **Billing/Stripe integration** | `validibot-pro` (private) | Pro feature |
| **Team management** | `validibot-pro` (private) | Pro feature |
| **Multi-organization support** | `validibot-enterprise` (private) | Enterprise feature |
| **SSO/SAML** | `validibot-enterprise` (private) | Enterprise feature |

### When Writing New Code

Before adding new features, ask: "Is this a Pro/Enterprise feature?"

- **If Pro feature** → Add to `../validibot-pro`
- **If Enterprise feature** → Add to `../validibot-enterprise`
