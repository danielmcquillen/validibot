...
Validibot doesn't include a reverse proxy by default—most operators already have one in their infrastructure. You'll need to set up your own for TLS termination.
