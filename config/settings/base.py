...
ENABLE_RESOURCES_SECTION = env.bool("ENABLE_RESOURCES_SECTION", False)
ENABLE_DOCS_SECTION = env.bool("ENABLE_DOCS_SECTION", False)
ENABLE_BLOG = env.bool("ENABLE_BLOG", False)
