...
| Self-hosted | single-host self-hosting on a VPS, VM, or on-prem server | [Self-Hosting Overview](https://github.com/mcquilleninteractive/validibot/blob/main/docs/operations/self-hosting/overview.md) (operator-facing) or [Deploy with Docker Compose](deploy-docker-compose.md) (developer-facing) |
...
- [Self-Hosting on DigitalOcean](https://github.com/mcquilleninteractive/validibot/blob/main/docs/operations/self-hosting/providers/digitalocean.md) — canonical operator-facing tutorial
