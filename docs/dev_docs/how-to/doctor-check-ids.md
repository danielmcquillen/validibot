...
- [Self-hosting Overview](https://github.com/mcquilleninteractive/validibot/blob/main/docs/operations/self-hosting/overview.md) — operator-facing guide that points at doctor checks for go-live.
