...
| **[Building Benchmark Reports](portfolio-manager-validator.md)** | Validates exports from ENERGY STAR® Portfolio Manager®, Washington Form C readiness, EUIt comparisons, and ZIP collections | XLS, XLSX, XML, ZIP |
