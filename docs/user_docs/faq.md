...
Workflow Authors can add CEL-based assertions to individual steps. For completely custom logic, you can create a custom validator. See [Workflow Management](workflow-management.md#step-assertions) and the [CEL Expressions guide](../help_pages/concepts/cel-expressions.md).
