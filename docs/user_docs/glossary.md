...
A simple expression language used to write validation rules. CEL expressions evaluate to true or false and can reference fields in your data. See the [CEL Expressions guide](../help_pages/concepts/cel-expressions.md).
