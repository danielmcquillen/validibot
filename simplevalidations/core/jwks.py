...
def get_public_key_der(key_resource_name: str) -> bytes:
    ...
    """
    from simplevalidations.core.gcp_kms import get_public_key_der as gcp_get_der
...
def kid_from_der(der: bytes) -> str:
    ...
    from simplevalidations.core.gcp_kms import kid_from_der as gcp_kid_from_der
