...
(() => {
  ...
  // simplevalidations/static/src/ts/catalogFilter.ts
  ...
  // simplevalidations/static/src/ts/assertionForm.ts
  ...
  // simplevalidations/static/src/ts/submitContentForm.ts
  var WORKFLOW_LAUNCH_FORM_SELECTOR = "[data-workflow-launch-form]";
  function isContentMode(value) {
  ...
  var WorkflowLaunchFormController = class {
    constructor(form) {
      ...
      this.payloadField = this.pasteSection?.querySelector("textarea") ?? null;
      this.fileInput = form.querySelector("[data-dropzone-input]");
      this.dropzone = form.querySelector("[data-dropzone]");
      this.dropzoneLabel = form.querySelector("[data-dropzone-file]");
      this.browseButton = form.querySelector("[data-dropzone-browse]");
    ...
    bindDropzone() {
      ...
      this.dropzone.addEventListener("keypress", (event) => {
  ...
  function initWorkflowLaunchForms(root = document) {
    const forms = root.querySelectorAll(WORKFLOW_LAUNCH_FORM_SELECTOR);
    forms.forEach((form) => {
