    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('validation_type', models.CharField(choices=[('JSON_SCHEMA', 'JSON Schema'), ('XML_SCHEMA', 'XML Schema'), ('ENERGYPLUS', 'EnergyPlus'), ('CUSTOM_RULES', 'Custom Rules'), ('AI_ASSIST', 'AI Assist')], max_length=40)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to=simplevalidations.validations.models.artifact_upload_to)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ruleset_type', models.CharField(choices=[('JSON_SCHEMA', 'JSON Schema'), ('XML_SCHEMA', 'XML Schema'), ('ENERGYPLUS', 'EnergyPlus'), ('CUSTOM_RULES', 'Custom Rules')], help_text="Type of validation ruleset, e.g. 'json_schema', 'xml_schema'", max_length=40)),
