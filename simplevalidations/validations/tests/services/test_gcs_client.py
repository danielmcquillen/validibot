...
from simplevalidations.validations.services.cloud_run.gcs_client import parse_gcs_uri
...
@patch("simplevalidations.validations.services.cloud_run.gcs_client.storage.Client")
