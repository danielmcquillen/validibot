"""
Base class for synchronous, inline validator engines.
...
class SimpleValidatorEngine(BaseValidatorEngine):
    """
    Abstract base for synchronous validator engines using the Template Method pattern.
