...
This reads seed data from validibot.validations.seeds and ensures
the corresponding Validator and ValidatorCatalogEntry rows exist.
"""
...
class Command(BaseCommand):
    help = "Sync system validators and their catalog entries from seed data."
