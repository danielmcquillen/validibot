"""
Self-hosted execution backend using Docker.
...
- Self-hosted deployments (VPS, on-premise)
...
class SelfHostedExecutionBackend(ExecutionBackend):
    """
    Self-hosted execution backend using Docker containers.
    ...
    def __init__(self) -> None:
        """Initialize the self-hosted backend."""
        self._storage = None
        self._runner = None

    @property
    def is_async(self) -> bool:
        """Self-hosted execution is synchronous."""
        return False
