...
def test_resolve_input_value_dotted_path():
    ...
    value = resolve_input_value(payload, data_path="outer.inner.value", slug="value")
...
def test_resolve_input_value_slug_default():
    ...
    value = resolve_input_value(payload, data_path="", slug="temperature")
...
def test_resolve_input_value_missing_returns_none():
    ...
    payload = {"temperature": 21}
    value = resolve_input_value(payload, data_path="outer.inner", slug="temperature")
