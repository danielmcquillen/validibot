...
class SimpleProcessorOutputValuesTests(TestCase):
    """Tests for output-value persistence in the simple validation processor."""
    ...
    def test_simple_processor_stores_canonical_output_values(self):
        ...
        output_values = {"output_temp": 18.5}

        class FakeValidator:
            """Minimal validator stub returning output_values for simple processing."""
        ...
        self.assertEqual(step_run.output_values, output_values)
